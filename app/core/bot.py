...
from app.core.data import Course, load_courses
from app.core.help import HelpCommand
from app.core.models import Command, Context, GroupCommand
from app.database import Database
from config import (
    allowed_mentions, default_prefix, description, name, owner, token, version,
)

if TYPE_CHECKING:
    from discord.abc import Snowflake

type AppCommandStore = dict[str, app_commands.AppCommand]
...
class Bot(commands.Bot):
    ...
    async def setup_hook(self) -> None:
        ...
        self.loop.create_task(self._dispatch_first_ready()).get_loop()  # NOTE: call to .get_loop() is a workaround for a bug in PyCharm
